...
import { Communicator, CommunicatorType } from ':core/communicator/Communicator';
import { SignerType } from ':core/message';
import { determineMethodCategory } from ':core/provider/method';
import { ScopedLocalStorage } from ':util/ScopedLocalStorage';

class CoinbaseWalletProviderBase extends EventEmitter implements ProviderInterface {
  ...
  constructor({
    ...
    this.communicator = communicator ?? new Communicator(keysUrl);
    this.chain = {
...
export { CoinbaseWalletProviderBase };
